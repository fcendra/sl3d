...
SCANNET_DIR = 'sl3d_data/scans'
TRAIN_SCAN_NAMES = [line.rstrip() for line in open('meta_data/scannet_val.txt')]
...
MAX_NUM_POINT = 50000
OUTPUT_FOLDER = './sl3d_data/votenet_scannet_train_detection_data'
